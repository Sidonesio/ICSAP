...
# packages' names
packages <- c("tidyverse", "read.dbc", "data.table","plyr")
...
for (i in arquivos$arquivos) {
  if(cont==0) {
    SP2002 <- read.dbc(paste("./", i, sep=""))
  } else {
    temp <- read.dbc(paste("./", i, sep=""))
    SP2002 <- rbind(SP2002, temp)
  }
  print(i)
  cont=cont+1
}

# first data loading - other months
SP_Ago <- read.dbc("./RDSP0208.dbc")
SP_Set <- read.dbc("./RDSP0209.dbc")
SP_Out <- read.dbc("./RDSP0210.dbc")
SP_Nov <- read.dbc("./RDSP0211.dbc")
SP_Dez <- read.dbc("./RDSP0212.dbc")

# view column names on both data sets
colnames(AC2002)
colnames(AC_Dez)
# variables that were added (indexes): 66:68
# variables that were added (names): "GESTOR_COD"; "GESTOR_CPF"; "GESTOR_DT"

# bind UF data frames
SP2002 <- bind_rows(SP2002,SP_Ago,SP_Set,SP_Out,SP_Nov,SP_Dez)

# extract data - subset
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(SP2002, file ="./SP2002.csv")

# merge data sets - subset
SIH2002 <- as.data.frame(rbind(AC2002,AL2002,AM2002,AP2002,BA2002,CE2002,DF2002,
                               ES2002,GO2002,MA2002,MG2002,MS2002,MT2002,PA2002,
                               PB2002,PE2002,PI2002,PR2002,RJ2002,RN2002,RO2002,
                               RR2002,RS2002,SC2002,SE2002,SP2002,TO2002))

# extract data - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(SIH2002, file ="./SIH2002.csv")

# second data loading - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
SIH2002 <- read.csv2(unz("./SIH.zip", "SIH2002.csv"), header=TRUE, sep=";")

# build and export data set of rows and columns (dimensions)
dimSIH2002 <- as.data.frame(cbind(2002, t(dim(SIH2002))))
library(data.table)
setnames(dimSIH2002, old = c("V1","V2","V3"), new = c("Year","Rows","Columns"))
wd3 <- "C:/Users/Dell/OneDrive/R/ICSAP/Arquivos exportados"
setwd(wd3)
getwd()
write.csv2(dimSIH2002, file ="./dimSIH2002.csv")

# build and export data set of column names
colnamesSIH2002 <- as.data.frame(colnames(SIH2002))
colnames(colnamesSIH2002)[1] <- "2002"
write.csv2(colnamesSIH2002, file ="./colnamesSIH2002.csv")
...
for (i in arquivos$arquivos) {
  if(cont==0) {
    SP2003 <- read.dbc(paste("./", i, sep=""))
  } else {
    temp <- read.dbc(paste("./", i, sep=""))
    SP2003 <- rbind(SP2003, temp)
  }
  print(i)
  cont=cont+1
}
...
# first data loading - other months
AGO <- read.dbc("./RDSP0308.dbc")
SET <- read.dbc("./RDSP0309.dbc")
OUT <- read.dbc("./RDSP0310.dbc")
NOV <- read.dbc("./RDSP0311.dbc")
DEZ <- read.dbc("./RDSP0312.dbc")

# bind UF data frames
SP2003 <- rbind.fill(SP2003,AGO,SET,OUT,NOV,DEZ)

# extract data - subset
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(SP2003, file ="./SP2003.csv")

# second data loading - subset
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
AC2003 <- read.csv2("./AC2003.csv", header=TRUE, sep=";")
AL2003 <- read.csv2("./AL2003.csv", header=TRUE, sep=";")
AM2003 <- read.csv2("./AM2003.csv", header=TRUE, sep=";")
AP2003 <- read.csv2("./AP2003.csv", header=TRUE, sep=";")
BA2003 <- read.csv2("./BA2003.csv", header=TRUE, sep=";")
CE2003 <- read.csv2("./CE2003.csv", header=TRUE, sep=";")
DF2003 <- read.csv2("./DF2003.csv", header=TRUE, sep=";")
ES2003 <- read.csv2("./ES2003.csv", header=TRUE, sep=";")
GO2003 <- read.csv2("./GO2003.csv", header=TRUE, sep=";")
MA2003 <- read.csv2("./MA2003.csv", header=TRUE, sep=";")
MG2003 <- read.csv2("./MG2003.csv", header=TRUE, sep=";")
MS2003 <- read.csv2("./MS2003.csv", header=TRUE, sep=";")
MT2003 <- read.csv2("./MT2003.csv", header=TRUE, sep=";")
PA2003 <- read.csv2("./PA2003.csv", header=TRUE, sep=";")
PB2003 <- read.csv2("./PB2003.csv", header=TRUE, sep=";")
PE2003 <- read.csv2("./PE2003.csv", header=TRUE, sep=";")
PI2003 <- read.csv2("./PI2003.csv", header=TRUE, sep=";")
PR2003 <- read.csv2("./PR2003.csv", header=TRUE, sep=";")
RJ2003 <- read.csv2("./RJ2003.csv", header=TRUE, sep=";")
RN2003 <- read.csv2("./RN2003.csv", header=TRUE, sep=";")
RO2003 <- read.csv2("./RO2003.csv", header=TRUE, sep=";")
RR2003 <- read.csv2("./RR2003.csv", header=TRUE, sep=";")
RS2003 <- read.csv2("./RS2003.csv", header=TRUE, sep=";")
SC2003 <- read.csv2("./SC2003.csv", header=TRUE, sep=";")
SE2003 <- read.csv2("./SE2003.csv", header=TRUE, sep=";")
SP2003 <- read.csv2("./SP2003.csv", header=TRUE, sep=";")
TO2003 <- read.csv2("./TO2003.csv", header=TRUE, sep=";")

# merge data sets - subset
SIH2003 <- as.data.frame(rbind(AC2003,AL2003,AM2003,AP2003,BA2003,CE2003,DF2003,
                               ES2003,GO2003,MA2003,MG2003,MS2003,MT2003,PA2003,
                               PB2003,PE2003,PI2003,PR2003,RJ2003,RN2003,RO2003,
                               RR2003,RS2003,SC2003,SE2003,SP2003,TO2003))

# extract data - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(SIH2003, file ="./SIH2003.csv")

# second data loading - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
SIH2003 <- read.csv2(unz("./SIH.zip", "SIH2003.csv"), header=TRUE, sep=";")

# build and export data set of rows and columns (dimensions)
dimSIH2003 <- as.data.frame(cbind(2003, t(dim(SIH2003))))
library(data.table)
setnames(dimSIH2003, old = c("V1","V2","V3"), new = c("Year","Rows","Columns"))
wd3 <- "C:/Users/Dell/OneDrive/R/ICSAP/Arquivos exportados"
setwd(wd3)
getwd()
write.csv2(dimSIH2003, file ="./dimSIH2003.csv")

# build and export data set of column names
colnamesSIH2003 <- as.data.frame(colnames(SIH2003))
colnames(colnamesSIH2003)[1] <- "2003"
write.csv2(colnamesSIH2003, file ="./colnamesSIH2003.csv")
...
for (i in arquivos$arquivos) {
  if(cont==0) {
    TO2004 <- read.dbc(paste("./", i, sep=""))
  } else {
    temp <- read.dbc(paste("./", i, sep=""))
    TO2004 <- rbind(TO2004, temp)
  }
  print(i)
  cont=cont+1
}
...
# first data loading - other months
JUL <- read.dbc("./RDTO0407.dbc")
AGO <- read.dbc("./RDTO0408.dbc")
SET <- read.dbc("./RDTO0409.dbc")
OUT <- read.dbc("./RDTO0410.dbc")
NOV <- read.dbc("./RDTO0411.dbc")
DEZ <- read.dbc("./RDTO0412.dbc")

# bind UF data frames
TO2004 <- rbind.fill(TO2004,JUL,AGO,SET,OUT,NOV,DEZ)

# extract data - subset
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(TO2004, file ="./TO2004.csv")

# second data loading - subset
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
AC2004 <- read.csv2("./AC2004.csv", header=TRUE, sep=";")
AL2004 <- read.csv2("./AL2004.csv", header=TRUE, sep=";")
AM2004 <- read.csv2("./AM2004.csv", header=TRUE, sep=";")
AP2004 <- read.csv2("./AP2004.csv", header=TRUE, sep=";")
BA2004 <- read.csv2("./BA2004.csv", header=TRUE, sep=";")
CE2004 <- read.csv2("./CE2004.csv", header=TRUE, sep=";")
DF2004 <- read.csv2("./DF2004.csv", header=TRUE, sep=";")
ES2004 <- read.csv2("./ES2004.csv", header=TRUE, sep=";")
GO2004 <- read.csv2("./GO2004.csv", header=TRUE, sep=";")
MA2004 <- read.csv2("./MA2004.csv", header=TRUE, sep=";")
MG2004 <- read.csv2("./MG2004.csv", header=TRUE, sep=";")
MS2004 <- read.csv2("./MS2004.csv", header=TRUE, sep=";")
MT2004 <- read.csv2("./MT2004.csv", header=TRUE, sep=";")
PA2004 <- read.csv2("./PA2004.csv", header=TRUE, sep=";")
PB2004 <- read.csv2("./PB2004.csv", header=TRUE, sep=";")
PE2004 <- read.csv2("./PE2004.csv", header=TRUE, sep=";")
PI2004 <- read.csv2("./PI2004.csv", header=TRUE, sep=";")
PR2004 <- read.csv2("./PR2004.csv", header=TRUE, sep=";")
RJ2004 <- read.csv2("./RJ2004.csv", header=TRUE, sep=";")
RN2004 <- read.csv2("./RN2004.csv", header=TRUE, sep=";")
RO2004 <- read.csv2("./RO2004.csv", header=TRUE, sep=";")
RR2004 <- read.csv2("./RR2004.csv", header=TRUE, sep=";")
RS2004 <- read.csv2("./RS2004.csv", header=TRUE, sep=";")
SC2004 <- read.csv2("./SC2004.csv", header=TRUE, sep=";")
SE2004 <- read.csv2("./SE2004.csv", header=TRUE, sep=";")
SP2004 <- read.csv2("./SP2004.csv", header=TRUE, sep=";")
TO2004 <- read.csv2("./TO2004.csv", header=TRUE, sep=";")

# merge data sets - subset
SIH2004 <- as.data.frame(rbind(AC2004,AL2004,AM2004,AP2004,BA2004,CE2004,DF2004,
                               ES2004,GO2004,MA2004,MG2004,MS2004,MT2004,PA2004,
                               PB2004,PE2004,PI2004,PR2004,RJ2004,RN2004,RO2004,
                               RR2004,RS2004,SC2004,SE2004,SP2004,TO2004))

# extract data - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(SIH2004, file ="./SIH2004.csv")

# second data loading - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
SIH2004 <- read.csv2(unz("./SIH.zip", "SIH2004.csv"), header=TRUE, sep=";")

# build and export data set of rows and columns (dimensions)
dimSIH2004 <- as.data.frame(cbind(2004, t(dim(SIH2004))))
library(data.table)
setnames(dimSIH2004, old = c("V1","V2","V3"), new = c("Year","Rows","Columns"))
wd3 <- "C:/Users/Dell/OneDrive/R/ICSAP/Arquivos exportados"
setwd(wd3)
getwd()
write.csv2(dimSIH2004, file ="./dimSIH2004.csv")

# build and export data set of column names
colnamesSIH2004 <- as.data.frame(colnames(SIH2004))
colnames(colnamesSIH2004)[1] <- "2004"
write.csv2(colnamesSIH2004, file ="./colnamesSIH2004.csv")
...
for (i in arquivos$arquivos) {
  if(cont==0) {
    SP2006 <- read.dbc(paste("./", i, sep=""))
  } else {
    temp <- read.dbc(paste("./", i, sep=""))
    SP2006 <- rbind(SP2006, temp)
  }
  print(i)
  cont=cont+1
}
...
# first data loading - other months
ABR <- read.dbc("./RDSP0604.dbc")
MAI <- read.dbc("./RDSP0605.dbc")
JUN <- read.dbc("./RDSP0606.dbc")
JUL <- read.dbc("./RDSP0607.dbc")
AGO <- read.dbc("./RDSP0608.dbc")
SET <- read.dbc("./RDSP0609.dbc")
OUT <- read.dbc("./RDSP0610.dbc")
NOV <- read.dbc("./RDSP0611.dbc")
DEZ <- read.dbc("./RDSP0612.dbc")
...
# match both vectors
!match(a,b)
# outcome: different columns (50: "COD_ARQ"; 51: "CONT"; 70: "COD_SEG")

# bind UF data frames
library(plyr)
SP2006 <- rbind.fill(SP2006,ABR,MAI,JUN,JUL,AGO,SET,OUT,NOV,DEZ)

# extract data - subset
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(SP2006, file ="./SP2006.csv")

# second data loading - subset
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
AC2006 <- read.csv2("./AC2006.csv", header=TRUE, sep=";")
AL2006 <- read.csv2("./AL2006.csv", header=TRUE, sep=";")
AM2006 <- read.csv2("./AM2006.csv", header=TRUE, sep=";")
AP2006 <- read.csv2("./AP2006.csv", header=TRUE, sep=";")
BA2006 <- read.csv2("./BA2006.csv", header=TRUE, sep=";")
CE2006 <- read.csv2("./CE2006.csv", header=TRUE, sep=";")
DF2006 <- read.csv2("./DF2006.csv", header=TRUE, sep=";")
ES2006 <- read.csv2("./ES2006.csv", header=TRUE, sep=";")
GO2006 <- read.csv2("./GO2006.csv", header=TRUE, sep=";")
MA2006 <- read.csv2("./MA2006.csv", header=TRUE, sep=";")
MG2006 <- read.csv2("./MG2006.csv", header=TRUE, sep=";")
MS2006 <- read.csv2("./MS2006.csv", header=TRUE, sep=";")
MT2006 <- read.csv2("./MT2006.csv", header=TRUE, sep=";")
PA2006 <- read.csv2("./PA2006.csv", header=TRUE, sep=";")
PB2006 <- read.csv2("./PB2006.csv", header=TRUE, sep=";")
PE2006 <- read.csv2("./PE2006.csv", header=TRUE, sep=";")
PI2006 <- read.csv2("./PI2006.csv", header=TRUE, sep=";")
PR2006 <- read.csv2("./PR2006.csv", header=TRUE, sep=";")
RJ2006 <- read.csv2("./RJ2006.csv", header=TRUE, sep=";")
RN2006 <- read.csv2("./RN2006.csv", header=TRUE, sep=";")
RO2006 <- read.csv2("./RO2006.csv", header=TRUE, sep=";")
RR2006 <- read.csv2("./RR2006.csv", header=TRUE, sep=";")
RS2006 <- read.csv2("./RS2006.csv", header=TRUE, sep=";")
SC2006 <- read.csv2("./SC2006.csv", header=TRUE, sep=";")
SE2006 <- read.csv2("./SE2006.csv", header=TRUE, sep=";")
SP2006 <- read.csv2("./SP2006.csv", header=TRUE, sep=";")
TO2006 <- read.csv2("./TO2006.csv", header=TRUE, sep=";")

# merge data sets - subset
SIH2006 <- as.data.frame(rbind(AC2006,AL2006,AM2006,AP2006,BA2006,CE2006,DF2006,
                               ES2006,GO2006,MA2006,MG2006,MS2006,MT2006,PA2006,
                               PB2006,PE2006,PI2006,PR2006,RJ2006,RN2006,RO2006,
                               RR2006,RS2006,SC2006,SE2006,SP2006,TO2006))

# extract data - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
write.csv2(SIH2006, file ="./SIH2006.csv")

# second data loading - complete
wd2 <- "C:/Users/Dell/OneDrive/R/Bancos de dados/SIH/CSV"
setwd(wd2)
getwd()
SIH2006 <- read.csv2(unz("./SIH.zip", "SIH2006.csv"), header=TRUE, sep=";")

# build and export data set of rows and columns (dimensions)
dimSIH2006 <- as.data.frame(cbind(2006, t(dim(SIH2006))))
library(data.table)
setnames(dimSIH2006, old = c("V1","V2","V3"), new = c("Year","Rows","Columns"))
wd3 <- "C:/Users/Dell/OneDrive/R/ICSAP/Arquivos exportados"
setwd(wd3)
getwd()
write.csv2(dimSIH2006, file ="./dimSIH2006.csv")

# build and export data set of column names
colnamesSIH2006 <- as.data.frame(colnames(SIH2006))
colnames(colnamesSIH2006)[1] <- "2006"
write.csv2(colnamesSIH2006, file ="./colnamesSIH2006.csv")
